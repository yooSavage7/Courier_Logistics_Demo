      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a
              href="#tracking"
              className="inline-flex items-center gap-2 bg-[#dc2626] hover:bg-[#b91c1c] text-white font-bold px-8 py-4 rounded-lg transition-colors text-base shadow-lg shadow-red-900/20"
            >
              Get Started Today
