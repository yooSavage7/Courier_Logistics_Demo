    ...
    <section id="services" className="py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
          {services.slice(0, 4).map((service, i) => (
            <motion.div
              ...
              className="bg-white rounded-xl p-6 border border-slate-200 hover:border-[#dc2626]/30 hover:shadow-lg transition-all cursor-default group"
            >
              <div className="w-12 h-12 bg-slate-50 group-hover:bg-[#b91c1c]/10 rounded-lg flex items-center justify-center mb-4 transition-colors">
                <service.icon className="w-6 h-6 text-[#0f172a] group-hover:text-[#dc2626] transition-colors" />
              </div>
              <h3 className="font-black text-[#0f172a] mb-2 text-sm">{service.title}</h3>
        ...
        <div className="text-center">
          <a href="#contact" className="text-[#0f172a] font-semibold text-sm hover:text-[#dc2626] transition-colors">
            View All Services →
          </a>
        </div>
      </div>
