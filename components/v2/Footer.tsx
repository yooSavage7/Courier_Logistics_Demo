          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-5">
              <div className="flex flex-col leading-none">
                <span className="text-[#dc2626] font-black text-xl tracking-tight uppercase">CLASSY</span>
              ...
              <ul className="space-y-3">
                {links.map((link) => (
                  <li key={link}>
                    <Link
                      href="#"
                      className="text-slate-400 text-sm hover:text-[#dc2626] transition-colors"
                    >
                      {link}
                    </Link>
                  </li>
