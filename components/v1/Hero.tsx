  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-hidden="true"
      />
      {/* Dark navy overlay — shifts warm image to cool V1 palette */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 w-full">
        <div className="max-w-2xl">
          ...
          >
            <span className="inline-block bg-[#f59e0b]/20 text-[#f59e0b] text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-6 border border-[#f59e0b]/30">
          ...
          >
            ...
            <span className="block">
              Across{" "}
              <span className="text-[#f59e0b]">Borders</span>
            </span>
          </motion.h1>
          ...
          >
            <a
              href="#tracking"
              className="inline-flex items-center gap-2 bg-[#f59e0b] hover:bg-[#d97706] text-white font-bold px-8 py-4 rounded-lg transition-colors text-base shadow-lg shadow-[#f59e0b]/25"
            >
      ...
      {/* Feature Bar */}
      <div className="relative z-10 bg-white/5 backdrop-blur-sm border-t border-white/10 mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 divide-x divide-white/10">
            {features.map(({ icon: Icon, label }) => (
              ...
              >
                <Icon className="w-5 h-5 text-[#f59e0b] flex-shrink-0" />
