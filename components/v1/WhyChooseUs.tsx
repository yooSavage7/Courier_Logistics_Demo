        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {reasons.map((reason, i) => (
            <motion.div
              ...
              className="flex items-start gap-4 p-6 rounded-xl bg-slate-50 hover:bg-[#f59e0b]/5 border border-transparent hover:border-[#f59e0b]/20 transition-all group"
            >
              <div className="w-11 h-11 bg-[#0f172a] group-hover:bg-[#f59e0b] rounded-lg flex items-center justify-center flex-shrink-0 transition-colors">
